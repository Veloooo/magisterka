...
export class MapComponent implements OnInit {
    ...
    getUnitImage(fraction: string, id: number) {
        let extension = (fraction == 'Demon') ? '.png' : '.jpeg';
        return '../../../assets/images/units/' + fraction + '/' + this.getUnitNameByFraction(fraction, id) + extension;
    }
}
